...
pros::Motor left_catapult(LEFT_CATAPULT_PORT,  pros::E_MOTOR_GEARSET_18, true); // Creates left catapult motor object
...
pros::Motor left_wing(LEFT_WING_PORT, pros::E_MOTOR_GEARSET_06, true); // Creates left wing motor object
pros::Motor right_wing(RIGHT_WING_PORT, pros::E_MOTOR_GEARSET_06, false); // Creates right wing motor object
